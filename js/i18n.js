...
const I18N = {
  zh: {
    ...
    tl1_year: '2025 — 至今',
    tl1_role: '视觉模型开发实习生',
    tl1_company: '@ 某 AI 科技公司',
    tl1_desc: '参与视觉检测模型的研发与落地，基于 YOLO、SAM 等模型进行工业视觉场景的算法设计与优化，推动模型在实际产线中的部署应用。',
    tl2_year: '2024 — 2025',
    tl2_role: '全栈开发实习生',
    tl2_company: '@ 某互联网公司',
    ...
    test2_text: '和 Eric 一起做大项目是一段很棒的经历。他对模型优化的执着和对代码质量的追求让整个团队受益匪浅，尤其是在 YOLO 和 SAM 的落地应用上。',
    ...
    // Footer
    footer_copy: '&copy; 2026 Eric. Built with <span class="heart">♥</span> and too much coffee.',
  ...
  en: {
    ...
    tl1_year: '2025 — Present',
    tl1_role: 'Vision Model Dev Intern',
    tl1_company: '@ AI Tech Company',
    tl1_desc: 'Participating in R&D of visual detection models, designing and optimizing algorithms based on YOLO and SAM for industrial vision scenarios, deploying models on production lines.',
    tl2_year: '2024 — 2025',
    tl2_role: 'Full-Stack Dev Intern',
    tl2_company: '@ Internet Company',
    ...
    test2_text: 'Working with Eric on major projects was a great experience. His dedication to model optimization and code quality elevated the entire team, particularly in YOLO and SAM deployment.',
